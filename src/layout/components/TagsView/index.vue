  ...
  <div id="tags-view-container" class="tags-view-container">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper" @scroll="handleScroll">
      ...
      >
        ...
        <!-- <div class="title">{{ tag.title }}</div>    关于二级的切换按钮的展示-->
        <div class="title">{{index > 0 ? tag.meta.parentTitle:tag.title}}</div>   
  ...
  .tags-view-wrapper {
    .tags-view-item {
      ...
      &.active {
        ...
        .triangle{
          border-bottom: 32px solid hsla(0,0%,100%,.2);
        }
      }
      .title{
        padding: 0 10px;
      ...
      .triangle{
        ...
        top: 0;
        border-top: none;
        border-bottom: 32px solid hsla(0,0%,100%,.08);
        &.triangle-l{
